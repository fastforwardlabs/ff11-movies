  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Page, [{
    ...
    value: function render() {
      ...
      var reviews = data.filter(function (o) {
        ...
        new_r.author = lodash__WEBPACK_IMPORTED_MODULE_11__["sample"](_data_corpora_js__WEBPACK_IMPORTED_MODULE_12__["adjectives"]).toLowerCase().replace('-', '') + '-' + lodash__WEBPACK_IMPORTED_MODULE_11__["sample"](_data_corpora_js__WEBPACK_IMPORTED_MODULE_12__["nouns"]).toLowerCase().replace('-', '');
      ...
      var top_sentences = reviews.map(function (r) {
        ...
        function scaleScore(value) {
          if (value < 0) {
            return Object(_parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleRed"])(Math.abs(value) / max);
          } else {
            return Object(_parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleBlue"])(Math.abs(value) / max);
          }
        }

        var sentences = r.lime_tokens.map(function (t, i) {
          var score = r.lime_scores[i];
          console.log(Object(_parts_Static__WEBPACK_IMPORTED_MODULE_15__["colorExtend"])(scaleScore(score), 1));
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
        ...
        __self: this
      }, r.logits[1] > r.logits[0] ? react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("span", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 148
        },
        __self: this
      }, Math.round(counts[1] / combined.length * 100), "% positive") : react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("span", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 152
        },
        __self: this
      }, Math.round(counts[0] / combined.length * 100), "% negative"))), [['positive', top_pos, this.state.show_all_positive, 'show_all_positive'], ['negative', top_neg, this.state.show_all_negative, 'show_all_negative']].map(function (a) {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
          style: {
            marginBottom: grem
          },
        ...
        __self: this
      }, reviews.length, " reviews"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 222
        },
        ...
        if (r.class_probabilities[1] > r.class_probabilities[0]) {
          winner_index = 1;
          scaleWinner = _parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleBlue"];
          scaleLoser = _parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleRed"];
        } else {
          winner_index = 0;
          scaleWinner = _parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleRed"];
          scaleLoser = _parts_Static__WEBPACK_IMPORTED_MODULE_15__["scaleBlue"];
        }
...
//# sourceMappingURL=topic2.js.426daec17f454e6c031c.hot-update.js.map