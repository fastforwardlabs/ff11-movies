...
var Page = Object(next_router__WEBPACK_IMPORTED_MODULE_1__["withRouter"])(function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      style: {
        borderBottom: "solid ".concat(grem / 4, "px ").concat(scaleWinner(r.class_probabilities[winner_index])),
        borderLeft: "solid ".concat(grem / 4, "px ").concat(scaleWinner(r.class_probabilities[winner_index])),
        borderRight: "solid ".concat(grem / 4, "px ").concat(scaleWinner(r.class_probabilities[winner_index])),
        padding: "0 ".concat(grem / 2, "px ").concat(grem / 4, "px ").concat(grem / 2, "px"),
        marginBottom: grem
      },
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=topic2.js.6e7692f3de5bf853182e.hot-update.js.map