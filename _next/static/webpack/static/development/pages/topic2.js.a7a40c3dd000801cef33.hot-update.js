  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Page, [{
    ...
    value: function render() {
      ...
      var reviews = data.filter(function (o) {
        ...
        new_r.author = lodash__WEBPACK_IMPORTED_MODULE_10__["sample"](_data_corpora_js__WEBPACK_IMPORTED_MODULE_11__["adjectives"]).toLowerCase().replace('-', '') + '-' + lodash__WEBPACK_IMPORTED_MODULE_10__["sample"](_data_corpora_js__WEBPACK_IMPORTED_MODULE_11__["nouns"]).toLowerCase().replace('-', '');
        new_r.date = i * 2 + 3 + ' days ago';
        return new_r;
      });
      var sorted = reviews.slice();
      var top_sentences = reviews.map(function (r) {
        var max = Math.max(Math.abs(lodash__WEBPACK_IMPORTED_MODULE_10__["min"](r.lime_scores)), Math.abs(lodash__WEBPACK_IMPORTED_MODULE_10__["max"](r.lime_scores)));

        function scaleScore(value) {
          if (value < 0) {
            return Object(_parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleRed"])(Math.abs(value) / max);
          } else {
            return Object(_parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleBlue"])(Math.abs(value) / max);
          }
        }

        var sentences = r.lime_tokens.map(function (t, i) {
          var score = r.lime_scores[i];
          console.log(Object(_parts_Static__WEBPACK_IMPORTED_MODULE_14__["colorExtend"])(scaleScore(score), 1));
        ...
        var sorted = lodash__WEBPACK_IMPORTED_MODULE_10__["sortBy"](sentences, 'score');
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        ...
        __self: this
      }, topic_info.Plot)), [['positive', top_pos, this.state.show_all_positive, 'show_all_positive'], ['negative', top_neg, this.state.show_all_negative, 'show_all_negative']].map(function (a) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          style: {
            marginBottom: grem
          },
          ...
          __self: this
        }, top_pos.length, " ", a[0], " review highlights"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          style: {
            textIndent: grem
          },
          __source: {
          ...
          __self: this
        }, top_pos.slice(0, _this2.state[a[3]] ? Infinity : show_limit).map(function (s) {
        ...
        }), ' ', a[1].length > show_limit ? !_this2.state.a[2] ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("button", {
          style: {
        ...
        __self: this
      }, reviews.length, " reviews"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 168
        },
        ...
        if (r.class_probabilities[1] > r.class_probabilities[0]) {
          winner_index = 1;
          scaleWinner = _parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleBlue"];
          scaleLoser = _parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleRed"];
        } else {
          winner_index = 0;
          scaleWinner = _parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleRed"];
          scaleLoser = _parts_Static__WEBPACK_IMPORTED_MODULE_14__["scaleBlue"];
        }
        ...
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          ...
          __self: this
        }, class_labels[winner_index], " review"), " \xB7", ' ', react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("span", {
          style: {},
          __source: {
            fileName: _jsxFileName,
            lineNumber: 235
...
//# sourceMappingURL=topic2.js.a7a40c3dd000801cef33.hot-update.js.map