...
/* harmony import */ var chroma_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! chroma-js */ "../../node_modules/chroma-js/chroma.js");
/* harmony import */ var chroma_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(chroma_js__WEBPACK_IMPORTED_MODULE_13__);
...
/* harmony import */ var _parts_MovieGrid__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../parts/MovieGrid */ "./parts/MovieGrid.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      ...
      var boxed = data.reduce(function (dict, current) {
        var slice = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, dict);
      ...
      var movie_keys = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_2___default()(boxed);

      var promises = movie_keys.map(function (k, i) {
        return fetch("http://www.omdbapi.com/?apikey=af4abd65&i=".concat(k)).then(function (r) {
          return r.json();
        }).then(function (json) {
          var og_id = k;

          if (json.Title === '#DUPE#') {
            return fetch("http://www.omdbapi.com/?apikey=af4abd65&i=".concat(json.imdbID)).then(function (r) {
              return r.json();
            }).then(function (json) {
              var json_mod = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, json);
      ...
      _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.all(promises).then(function (results) {
        console.log(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(results));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        ...
        __self: this
      }, "Textflix")), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_parts_Bar__WEBPACK_IMPORTED_MODULE_14__["default"], {
        grem: grem,
        ...
        __self: this
      }, data.length, " movies & shows sorted by most:"), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        style: {
          display: 'flex',
          flexWrap: 'wrap',
          alignItems: 'center'
        ...
        return sort === a[1] ? react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
          key: a[0],
          style: {
            background: '#222',
            color: 'white',
          ...
          __self: this
        }, a[0]) : react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("button", {
          key: a[0],
      ...
      }))), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_parts_Static__WEBPACK_IMPORTED_MODULE_16__["Border"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 187
        },
        ...
        __self: this
      }, compare ? react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        style: {
          marginRight: -1,
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_parts_MovieGrid__WEBPACK_IMPORTED_MODULE_17__["default"], {
        data: nbsvm_data,
        info: info,
        grem: grem,
        sort: sort,
        ...
        __self: this
      }))) : null, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_parts_MovieGrid__WEBPACK_IMPORTED_MODULE_17__["default"], {
        data: data,
        info: info,
        grem: grem,
        sort: sort,
...
//# sourceMappingURL=index.js.05dab3b128a834c2ded5.hot-update.js.map