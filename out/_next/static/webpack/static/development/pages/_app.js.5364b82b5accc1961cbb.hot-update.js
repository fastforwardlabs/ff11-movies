...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Tour, [{
    ...
    value: function onScroll() {
      ...
      if (offsets) {
        var _scroller = this.scrollRef.current;
        ...
        for (var i = 0; i < offsets.length; i++) {
          ...
          if (_scroller.scrollTop > thresh - wh * (31 / 32)) {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (step !== 0 && step !== prev_step) {
        var _scroller2 = document.getElementById('frame-scroller');
...
//# sourceMappingURL=_app.js.5364b82b5accc1961cbb.hot-update.js.map